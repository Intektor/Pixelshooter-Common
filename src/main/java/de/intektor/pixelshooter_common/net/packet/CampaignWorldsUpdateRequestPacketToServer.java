 ...
 * @author Intektor
 */
public class CampaignWorldsUpdateRequestPacketToServer implements Packet {

    public Version version;

    public CampaignWorldsUpdateRequestPacketToServer() {

    }

    public CampaignWorldsUpdateRequestPacketToServer(Version version) {
